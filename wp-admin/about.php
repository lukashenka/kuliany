...
<div
	class="about-text"><?php printf(__('Thank you for updating! WordPress %s has lots of refinements we think you&#8217;ll love.'), $display_version); ?></div>
...
<div class="changelog">
	<div class="about-overview">
		...
		if (!is_ssl() && ($locale = get_locale()) && 'en_' === substr($locale, 0, 3)) : ?>
			<embed src="//v0.wordpress.com/player.swf?v=1.03" type="application/x-shockwave-flash" width="640"
			       height="360" wmode="direct" seamlesstabbing="true" allowfullscreen="true" allowscriptaccess="always"
			       overstretch="true" flashvars="guid=sAiXhCfV&amp;isDynamicSeeking=true" title=""></embed>
		<?php else : ?>
						...
						"tracks": [
							{
								...
								"image": {
									"src": "//s.w.org/images/core/3.9/louis.jpg",
									"width": 308,
									"height": 240
								},
								"thumb": {
	...
	<div class="feature-section col two-col">
		...
		<div class="last-feature">
			...
			<?php if (current_user_can('install_themes')) { ?>
				<p><a href="<?php echo network_admin_url('theme-install.php'); ?>"
				      class="button button-large button-primary"><?php _e('Browse Themes'); ?></a></p>
			<?php } ?>
		</div>
	</div>
</div>
