		...
		if (isset($_GET['submitted']) && isset($_GET['loginName']) && isset($_GET['key'])) {
			...
			if (!empty($user)) {
				...
				if (isset($_GET['finalAction']) && ($_GET['finalAction'] == 'yes')) {
					if ($messageNo2 == '2') {
						...
						?>
						<form enctype="multipart/form-data" method="post" id="recover_password2" class="user-forms"
						      action="<?php echo add_query_arg('finalAction', 'yes', wppb_curpageurl()); ?>">
							<?php
							...
							<p class="form-submit">
								...
								<input name="recover_password2" type="submit" id="recover_password2"
								       class="submit button"
								       value="<?php echo apply_filters('wppb_recover_password_button_name1', $button_name); ?>"/>
					...
					<form enctype="multipart/form-data" method="post" id="recover_password2" class="user-forms"
						...
						<p class="form-submit">
							<?php $button_name = __('Reset Password', 'profilebuilder'); ?>
							<input name="recover_password2" type="submit" id="recover_password2" class="submit button"
							       value="<?php echo apply_filters('wppb_recover_password_button_name2', $button_name); ?>"/>
							<input name="action2" type="hidden" id="action2" value="recover_password2"/>
						</p><!-- .form-submit -->
						<?php wp_nonce_field('verify_true_password_recovery2_' . $user->ID, 'password_recovery_nonce_field2'); ?>
					</form><!-- #recover_password -->
			...
			if (($messageNo == '') || ($messageNo == '2') || ($messageNo == '4')) {
				...
				<p class="form-submit">
					...
					<input name="recover_password" type="submit" id="recover_password" class="submit button"
					       value="<?php echo apply_filters('wppb_recover_password_button_name3', $button_name); ?>"/>
