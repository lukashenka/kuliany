...
function wppb_front_end_profile_info()
{
	...
	if (!is_user_logged_in()) {
		...
		<form enctype="multipart/form-data" method="post" id="edituser" class="user-forms"
		      action="<?php wppb_curpageurl(); ?>">
		<?php
		...
		<p class="form-submit">
			...
			<input name="updateuser" type="submit" id="updateuser" class="submit button"
			       value="<?php echo apply_filters('wppb_edit_profile_button_name', $button_name, $current_user); ?>"/>
