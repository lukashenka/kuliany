	...
	<div id="content_wrap">
		...
		if (!file_exists($wppb_premium . 'custom.fields.php')) {
			...
			<div class="info basic-version-info">
				...
				<a href="http://www.cozmoslabs.com/wordpress-profile-builder/?utm_source=wpbackend&utm_medium=clientsite&utm_content=link&utm_campaign=ProfileBuilderFree"
				   alt="Profile Builder Pro" title="Buy Profile Builder Pro"><img id="wppb_buyNowButton"
				                                                                  src="<?php echo WPPB_PLUGIN_URL ?>assets/images/buy_now_button.png"/></a>
			</div>
		<?php
		...
		<div id="content">
			...
			<div id="options_tabs">
				...
				<ul class="options_tabs">
					<li><a href="#profile-builder"><?php _e('Basic Information', 'profilebuilder'); ?></a><span></span>
					</li>
					<li><a href="#general-settings"><?php _e('General Settings', 'profilebuilder'); ?></a><span></span>
					</li>
					<li>
						<a href="#show-hide-admin-bar"><?php _e('Show/Hide the Admin Bar on Front-end', 'profilebuilder'); ?></a><span></span>
					</li>
					<li>
						<a href="#default-fields"><?php _e('Default Profile Fields', 'profilebuilder'); ?></a><span></span>
					</li>
					<?php
					$wppb_premium = WPPB_PLUGIN_DIR . '/premium/functions/';
					...
					if (file_exists($wppb_premium . 'custom.fields.php')) {
						echo '<li><a href="#create-extra-fields">';
						_e('Extra Profile Fields', 'profilebuilder');
						echo '</a><span></span></li>';
					}
					if (file_exists($wppb_addons . 'addon.php')) {
						echo '<li><a href="#add-ons">';
						_e('Addons', 'profilebuilder');
						echo '</a><span></span></li>';
					}
					if (file_exists($wppb_premium . 'custom.fields.php')) {
						echo '<li><a href="#register-profile-builder">';
						_e('Register Your Version', 'profilebuilder');
						echo '</a><span></span></li>';
					}
					?>
					<?php
					...
					if ($addons_options_set != 'not_found') {
						...
						foreach ($addons_options_set as $key => $value)
							if ($value == 'show') {
								echo '<li><a href="#' . $key . '">';
								_e($addons_options_description[$key], 'profilebuilder');
								echo '</a><span></span></li>';
							}
					}
					?>
