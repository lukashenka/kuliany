!function (a) {
    ...
    b.prototype.checkPosition = function () {
        if (this.$element.is(":visible")) {
            var i, b = a(document).height(), c = this.$window.scrollTop(), d = this.$element.offset(), e = this.options.offset, f = e.bottom, g = e.top, h = "affix affix-top affix-bottom";
    ...
    c.prototype.close = function (b) {
        ...
        var e, c = a(this), d = c.attr("data-target");
    ...
    a.fn.collapse = function (c) {
        ...
        var d, c = a(this), e = c.attr("data-target") || b.preventDefault() || (d = c.attr("href")) && d.replace(/.*(?=#[^\s]+$)/, ""), f = a(e).data("collapse") ? "toggle" : c.data();
    ...
    b.prototype = {cycle: function (b) {
        ...
        !a.support.transition && this.$element.hasClass("slide") && this.$element.find(".item").stop(!0, !0);
        var j, d = this.$element.find(".item.active"), e = c || d[b](), f = this.interval, g = "next" == b ? "left" : "right", h = "next" == b ? "first" : "last", i = this;
        if (this.sliding = !0, f && this.pause(), e = e.length ? e : this.$element.find(".item")[h](), j = a.Event("slide", {relatedTarget: e[0], direction: g}), !e.hasClass("active")) {
            ...
            } else if (!a.support.transition && this.$element.hasClass("slide")) {
                if (this.$element.trigger(j), j.isDefaultPrevented())return;
                d.animate({left: "right" == g ? "100%" : "-100%"}, 600, function () {
                    d.removeClass("active"), i.sliding = !1, setTimeout(function () {
                        i.$element.trigger("slid")
                    }, 0)
                }), e.addClass(b).css({left: "right" == g ? "-100%" : "100%"}).animate({left: "0"}, 600, function () {
                    e.removeClass(b).addClass("active")
                })
            } else {
                if (this.$element.trigger(j), j.isDefaultPrevented())return;
    ...
    a.fn.carousel = function (c) {
        ...
        var d, g, c = a(this), e = a(c.attr("data-target") || (d = c.attr("href")) && d.replace(/.*(?=#[^\s]+$)/, "")), f = a.extend({}, e.data(), c.data());
