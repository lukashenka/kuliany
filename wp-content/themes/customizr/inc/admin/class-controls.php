		...
		switch ($this->type) {
			...
			case 'number':
				...
				<label>
					...
					<input <?php $this->link() ?> type="number" step="<?php echo $this->step ?>"
					                              min="<?php echo $this->min ?>" id="posts_per_page"
					                              value="<?php echo $this->value() ?>"
					                              class="tc-number-input small-text">
			...
			case 'checkbox':
				...
				<input type="checkbox" class="iphonecheck"
			...
			case 'textarea':
				...
				<label>
					...
					<textarea class="widefat" rows="3"
					          cols="10" <?php $this->link(); ?>><?php echo esc_html($this->value()); ?></textarea>
				</label>
				<?php
				break;
